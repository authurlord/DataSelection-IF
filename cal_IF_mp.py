...
def calculate_ppl(
    ...
    create_folder_for_file('ppl/{}/{}/ppl-p2-{}.csv'.format(task,dataset_name,process_num))
    create_folder_for_file('grad/{}/{}/tr_grad_{}.pkl'.format(task,dataset_name,process_num))
    perplexities_df.to_csv('ppl/{}/{}/ppl-p2-{}.csv'.format(task,dataset_name,process_num))
    torch.save(tr_grad_dict,'grad/{}/{}/tr_grad_{}.pkl'.format(task,dataset_name,process_num))
    torch.save(id_list,'grad/{}/{}/tr_grad_index_{}.pkl'.format(task,dataset_name,process_num))
