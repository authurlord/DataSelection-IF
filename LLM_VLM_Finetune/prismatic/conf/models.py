...
# === LLaMa math ==
@dataclass
class LLaMa2_Math(ModelConfig):
    model_id: str = "llama2-math"
    ## unused
    ...
    finetune_global_batch_size: int = 8 #16
    finetune_per_device_batch_size: int = 4 # 16
    ...
    finetune_train_strategy: str = "fsdp-full-shard-llm"
...
class LLaVa_v15_Reproduction_7B(ModelConfig):
    ...
    align_global_batch_size: int = 32 #256
    align_per_device_batch_size: int = 16
...
# @dataclass
# class Exp_DataPrune_7B_One_Stage(Exp_7B_One_Stage):
#     model_id: str = "one-stage+7b+data-prune"
#     arch_specifier: str = "no-align+gelu-mlp"
#     vision_backbone_id: str = "clip-vit-l-336px"
