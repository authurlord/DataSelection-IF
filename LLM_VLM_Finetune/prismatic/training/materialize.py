...
from prismatic.training.strategies import FSDPStrategy, TrainingStrategy, FSDPStrategyLLM, TrainingStrategyLLM
...
TRAIN_STRATEGIES = {
    ...
    "fsdp-full-shard-llm": {"cls": FSDPStrategyLLM, "kwargs": {"sharding_strategy": "full-shard"}},
}


def get_train_strategy_llm(
    train_strategy: str,
    llm: PrismaticLLM,
    device_id: int,
    epochs: int,
