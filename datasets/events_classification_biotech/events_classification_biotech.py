...
TRAIN_DOWNLOAD_URL = "./train.csv"
TEST_DOWNLOAD_URL = "./test.csv"
...
class BiotechNews(datasets.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, filepath):
            ...
            for id_, example in enumerate(csv_reader):
                title, content, organization, label1, label2, label3, label4, label5 = example.values()
